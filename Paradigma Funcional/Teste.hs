...
--Funcao para calcular o MMQ com aproximacao Linear (y = a + bx)
...
--Funcao para calcular o MMQ com aproximacao Parabolica (y = a + bx^2)
aproxParab :: ([Float],[Float]) -> (Float, Float)
